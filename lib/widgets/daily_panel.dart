                ...
                if (unfinishedList)
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Icon(Icons.delete_rounded, color: Color(list[index].color)),
                    ),
                  ),
                GestureDetector(
                  onTap: () async {
                          ...
                          return GestureDetector(
                            ...
                            child: Scaffold(
                              ...
                              body: MultiBlocProvider(
                                ...
                                child: AddEventDialog.daily(event: list[index], fromDailyMonthlyList: true),
                              ),
                            ),
                          );
                        },
                          ...
                          return GestureDetector(
                            ...
                            child: Scaffold(
                              ...
                              body: MultiBlocProvider(
                                ...
                                child: AddEventDialog.daily(event: list[index], fromUnfinishedList: true),
                              ),
                            ),
                          );
                        },
                  ...
                  child: unfinishedList
                      ?
                        ...
                        Container(
                          ...
                          child: Text(list[index].text, maxLines: 2, style: Centre.dialogText),
                        )
      ...
      return Column(
        children: [
          ...
          Padding(
            ...
            child: Divider(color: Centre.pink, thickness: 2),
          ),
          Expanded(
