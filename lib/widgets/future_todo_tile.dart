              ...
              onDoubleTap: () {
                ...
                if (widget.todo.indented > 0) {
                  ...
                  while (todosToMove.isNotEmpty &&
                      indexAfterAllOfList + todosToMove.length <
                          futureList.length &&
                      futureList[indexAfterAllOfList + todosToMove.length]
                              .indented >=
                          futureList[indexAfterAllOfList].indented) {
                    todosToMove.add(
                        futureList[indexAfterAllOfList + todosToMove.length]);
                  ...
                  if (todosToMove.isNotEmpty) {
                    futureList.removeRange(indexAfterAllOfList,
                        indexAfterAllOfList + todosToMove.length);
                  ...
                  int currentWidgetIndex =
                      widget.todo.index + todosToMove.length;
                  ...
                  for (int i = currentWidgetIndex + 1;
                      i < futureList.length &&
                          futureList[currentWidgetIndex].indented <
                              futureList[i].indented;
                      i++) {
                    futureList[i].changeIndent(futureList[i].indented - 1);
                  }
                  futureList[currentWidgetIndex]
                      .changeIndent(widget.todo.indented - 1);
                  ...
                  if (futureList[currentWidgetIndex - 1].indented ==
                          widget.todo.indented &&
                    ...
                    GestureDetector(
                        onDoubleTap: () {
                          ...
                          if (widget.todo.indented < 4 &&
                            ...
                            while (indexTapped != -1 &&
                                futureList[indexTapped].indented !=
                                    widget.todo.indented) {
                              indexTapped--;
                            }
                            indexTapped = indexTapped == -1
                                ? widget.todo.index - 1
                                : indexTapped;
                            ...
                            for (int i = widget.todo.index + 1;
                                ...
                                i++) {
                              futureList[i]
                                  .changeIndent(futureList[i].indented + 1);
                            }
                            futureList[widget.todo.index]
                                .changeIndent(widget.todo.indented + 1);
                          ...
                          : BlocBuilder<TodoTextEditingCubit, int?>(
                              ...
                              return (indexEditing ?? -1) == widget.todo.index
                                  ? TextFormField(
                                      ...
                                      style: Centre.smallerDialogText.copyWith(
                                          fontSize:
                                              Centre.safeBlockHorizontal * 3.8),
                                    )
                                  : GestureDetector(
                                      onTap: () {
                                        context
                                    ...
                                    : tileBtn(
                                        ...
                                        onTap: () {
                                          ...
                                          if (addTileExists) {
                                            ...
                                            int addTileIndex = context
                                                .read<TodoTileAddCubit>()
                                                .state[0];
                                            context
                                                .read<TodoTileAddCubit>()
                                                .update([addTileIndex, 0, 1]);
                                          }
