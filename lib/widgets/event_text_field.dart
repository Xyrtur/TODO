...
class EventNameTextField extends StatefulWidget {
  ...
  const EventNameTextField({super.key, required this.controller, required this.formKey});
  @override
...
class _EventNameTextFieldState extends State<EventNameTextField> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.fromLTRB(Centre.safeBlockHorizontal * 4, Centre.safeBlockVertical * 2, 0, 0),
      child: SizedBox(
