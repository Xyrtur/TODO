    ...
    reorderablesList = [
      for (FutureTodo todo in list)
        MultiBlocProvider(
          ...
          child: FutureTodoTile(todo: todo, focusNode: editingFocusNode, textController: controller),
        ),
    ];
    if (addTileIndex != -1) {
  ...
  Widget addingTodoTile(int index, int indents) {
    ...
    return AnimatedBuilder(
      ...
      builder: (_, child) => ClipRect(
        child: Form(
          key: formKey,
          child: Align(alignment: Alignment.center, heightFactor: animation.value, widthFactor: null, child: child),
        ),
      ),
        ...
        child: SizedBox(
          ...
          child: Row(
            children: [
              ...
              Text(' \u2022 ', style: Centre.todoSemiTitle.copyWith(fontSize: Centre.safeBlockHorizontal * 8)),
              Expanded(
                child: TextFormField(
                  validator: (input) {
                  ...
                  decoration: InputDecoration(
                    counterText: "",
                    focusedBorder: UnderlineInputBorder(borderSide: BorderSide(color: Centre.primaryColor)),
                  ),
                ...
                children: [
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Icon(Icons.check, color: Centre.secondaryColor, size: Centre.safeBlockHorizontal * 5.5),
                    ),
                  ),
                  GestureDetector(
                    onTap: () {
                    ...
                    child: Container(
                      margin: EdgeInsets.symmetric(horizontal: Centre.safeBlockHorizontal * 2),
                      padding: EdgeInsets.all(Centre.safeBlockHorizontal * 1.5),
                      child: Icon(Icons.delete, color: Centre.red, size: Centre.safeBlockHorizontal * 5.5),
                    ),
                  ),
                ],
              ),
              ...
              Padding(
                ...
                child: Column(
                  children: [
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Icon(Icons.add, color: Centre.primaryColor, size: Centre.safeBlockHorizontal * 7),
                          ),
                        ),
                        GestureDetector(
                          onTap: () {
                            ...
                            context.read<TodoTextEditingCubit>().update(null);
                            if (reorderablesList.indexWhere((Widget widget) => widget.key == const ValueKey(12345)) !=
                                -1) {
                              animController.reverse();
                            }
                          },
                    ...
                    SizedBox(height: Centre.safeBlockVertical),
                    Divider(height: Centre.safeBlockVertical, color: Centre.secondaryColor),
                  ],
                ),
              ),
              Expanded(
                child: MultiBlocListener(
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              ...
                              action: SnackBarAction(
                                ...
                                onPressed: () {
                                  scaffoldKey.currentContext!.read<FutureTodoBloc>().add(
                                    FutureTodoUndoDelete(
                                      event: state.deletedTodo,
                                      undoIndentsIndices: state.deletedTreeIndexes,
                                    ),
                                  );
                                },
                              ),
                  ...
                  child: BlocBuilder<TodoTextEditingCubit, int?>(
                    builder: (tcontext, textEditingState) => BlocBuilder<TodoTileAddCubit, List<int>>(
                      builder: (tcontext, tileAddState) => BlocBuilder<FutureTodoBloc, FutureTodoState>(
                          ...
                          return SizedBox(
                            ...
                            child: ReorderableListView(
                              ...
                              onReorderStart: (index) {
                                ...
                                context.read<FutureTodoBloc>().add(FutureTodoListUpdate(eventList: state.futureList));
                              },
                              onReorder: (int old, int news) {
                                ...
                                if (oldList[old].indented != 0 &&
                                    ...
                                    (old + todosMoved.length == oldList.length ||
                                        !(oldList[old + todosMoved.length].indented == oldList[old].indented))) {
