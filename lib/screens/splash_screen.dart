      ...
      child: AnimatedSplashScreen.withScreenFunction(
        ...
        splash: AnimatedTextKit(
          animatedTexts: [
            TyperAnimatedText(
              '// TODO:',
              textStyle: TextStyle(fontSize: 32.0, fontFamily: 'Droid Sans', color: Centre.primaryColor),
          ...
          return RepositoryProvider.value(
            ...
            child: MultiBlocProvider(
              providers: [
                ...
                BlocProvider<FirstDailyDateBtnCubit>(create: (_) => FirstDailyDateBtnCubit()),
                BlocProvider<ImportExportBloc>(create: (context) => ImportExportBloc(context.read<HiveRepository>())),
