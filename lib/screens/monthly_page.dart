  ...
  Widget build(BuildContext context) {
    ...
    Widget fab = Padding(
      ...
      child: FloatingActionButton.small(
              ...
              child: Scaffold(
                ...
                body: MultiBlocProvider(
                  providers: [
                    ...
                    BlocProvider<CalendarTypeCubit>(create: (_) => CalendarTypeCubit(null)),
        ...
        child: Icon(Icons.add_rounded, color: Centre.bgColor, size: 30),
      ),
    );
        ...
        showAlignedDialog(
          ...
          builder: (BuildContext ycontext) {
            return MultiBlocProvider(
              providers: [
                BlocProvider(create: (_) => YearTrackingCubit(context.read<MonthDateCubit>().state.year)),
              ...
              listener: (context, state) {
                if (state is ImportFinished) {
                  context.read<MonthlyTodoBloc>().add(
                    MonthlyTodoDateChange(date: context.read<MonthDateCubit>().state),
                  );
